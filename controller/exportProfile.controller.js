...
module.exports = {
    addExportProfile: async (req, res) => {
        try {
    ...
    viewExportProfile: async (req, res) => {
    ...
    updateExportProfile: async (req, res) => {
    ...
    deleteExportProfile: async (req, res) => {
    ...
    getExportProfileById: async (req, res) => {
...
async function deleteExportProfileAccess(UserProfileId, UserName) {
